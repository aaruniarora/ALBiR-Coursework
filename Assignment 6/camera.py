...
class Cam(object):
    ...
    def get_blobs(self, angle = 0, pix_thresh=60) -> tuple:
        """
        ...
        blobs = img.find_blobs(self.thresholds,pixels_threshold=pix_thresh,area_threshold=60)
...
if __name__ == "__main__":
    ...
    thresholds = [
                    (36, 50, 6, 18, -45, -20), # Blue 20 AA
                    # (22, 28, -7, 13, -30, -13), # BLue 20 PP
                    # (61, 79, -2, 13, -22, -3), # White 20 AA
                    # (5, 12, -11, 4, -4, 7), # Black 20 AA
                    (37, 48, 20, 41, -15, 6), # Red 20 AA
    ...
    while True:
        ...
        for blob in img.find_blobs(thresholds, pixels_threshold=700, area_threshold=700):
