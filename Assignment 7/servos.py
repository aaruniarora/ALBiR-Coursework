...
if __name__ == "__main__":
    ...
    # # at 0.08, turning left is about 3500ms and turning right is about 7500ms
    # print('\nTurning left -0.08, 0.08')
    # servo.set_speed(-0.08,0.08)
    # time.sleep_ms(5000)
